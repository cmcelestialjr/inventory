            ...
            <div className="overflow-x-auto print:overflow-visible">
                    <table className="min-w-full divide-y divide-gray-200 border border-gray-200 shadow-lg">
                        <thead className="bg-gray-50 sticky top-0 z-10">
                            ...
                            <tr>
                                <th className="sticky left-0 top-0 z-20 bg-gray-100 px-3 py-3 text-xs font-medium text-gray-700 uppercase tracking-wider border-r border-gray-200" rowSpan="2">#</th>
                                <th className="sticky left-[40px] top-0 z-20 bg-gray-100 px-3 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider border-r border-gray-200" rowSpan="2">Name</th>
                            ...
                            {employees.map((emp, index) => {
                                ...
                                return (
                                    <tr key={emp.id} className="hover:bg-gray-50 transition duration-150 ease-in-out">
                                        {/* Index and Name */}
                                        <td className="sticky left-0 bg-white z-10 px-3 py-2 text-sm text-center text-gray-500 font-medium border-r border-gray-200">{index + 1}</td>

                                        <td className="sticky left-[40px] bg-white z-10 px-3 py-2 text-sm font-medium text-gray-900 whitespace-nowrap border-r border-gray-200">
                    ...
                    <table>
                        <thead>
                            ...
                            <tr>
                                ...
                                {printMode === "1P" && <th rowSpan="2">1st_P (d.h.m)</th>}
